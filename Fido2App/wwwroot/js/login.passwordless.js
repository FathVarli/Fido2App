document.getElementById('loginSubmit').addEventListener('click', handleSignInSubmit);
...
async function fetchAssertionOptions(requestData) {
    let response = await fetch('/assertionOptions', {
        method: 'POST', // or 'PUT'
